...
public class Kuznechik {
    ...
    static byte[] blk = parseHexBinary("8899aabbccddeeff0077665544332211");

    public static void main(String[] args)
    {
        GOST_Kuz_Expand_Key(key_1, key_2);
        byte[] encryptBlock = GOST_Kuz_Encrypt(blk);
        System.out.println(printHexBinary(encryptBlock));
        byte[] decryptBlock = GOST_Kuz_Decrypt(encryptBlock);
        System.out.println(printHexBinary(decryptBlock));
    }
